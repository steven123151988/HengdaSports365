 ...
 * Description:修改资金密码
 *
 * Data：2018/5/17-14:30
 * steven
 */
public class ChangeMoneypswActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_changemoneypsw;
    }

    @Override
    protected void initView(@Nullable Bundle savedInstanceState) {
        SystemUtil.setfullScreen(ChangeMoneypswActivity.this);
        tvCenterName.setText("修改资金密码");
    }
