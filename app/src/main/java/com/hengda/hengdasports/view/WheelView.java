...
package com.hengda.hengdasports.view;
...
public class WheelView extends View {
     ...
     * Scrolling duration
     */
    private static int SCROLLING_DURATION = 500;
    ...
    public void setItemHeight(Context context, int viewHeight) {
        WindowManager wm = (WindowManager) getContext()
                .getSystemService(Context.WINDOW_SERVICE);

        int width = wm.getDefaultDisplay().getWidth();
        int display = wm.getDefaultDisplay().getHeight();
        if (display == 1184) { // htc
            additional_item_height = (int) (viewHeight / 8.0);
        } else if (display == 1208) { // 索妮
            additional_item_height = (int) (viewHeight / 7.0);
        } else if (display <= 1280) { // 小米
            additional_item_height = (int) (viewHeight / 3.6);
        } else if (display == 1800) { // 魅族
            additional_item_height = (int) (viewHeight / 7.0);
        } else if (display < 1920) { // 五儿子
            additional_item_height = (int) (viewHeight / 3.8);
        } else if (display == 1920) { // 三星盖世
            additional_item_height = (int) (viewHeight / 3.5);
        } else if (display == 2560) {
            additional_item_height = (int) (viewHeight / 3.5);
        } else {
            additional_item_height = (int) (viewHeight / 4.0);
        }
    }
    ...
    private void initData(Context context) {
        ...
        SCROLLING_DURATION = AppUtils.dip2px(context, 144);
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(AppUtils.dip2px(getContext(), 14));
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(AppUtils.dip2px(getContext(), 22));
